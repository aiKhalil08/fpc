...
$classes = $classes->get();
$type = 'class_teacher';
if ($classes) $select_student = new Dec_Write_Comments($type, $classes);//declared in page_view.php
...
<body>
	...
	<main>
        ...
        <section class='student_results'>
			...
			<?php
            echo $classes ? $select_student->dec_select_class() : '<strong>YOU ARE NOT THE CLASS TEACHER OF ANY CLASS.</strong>';
			?>
        </section>
    </main>
    <footer>

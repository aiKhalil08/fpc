		...
		<section class='login'>
			...
			<article class='login_form'>
				<form method="post" action="loginx.php">
					<p>Log in:</p>
					<p><input type="text" name="writer_username" placeholder='username...'></p>
					<p><input type="password" name="writer_password" placeholder='password...'><i id='show_password' class="fa-solid fa-eye-slash fa-sm"></i></p>
					<p><input type="submit" name="writer_login" value="Login"></p>
				</form>
			</article>
		</section>
	</div>

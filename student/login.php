		...
		<section class='login'>
			...
			<article class='login_form'>
				<form method="post" action="loginx.php">
					<p>Log in:</p>
					<p><input type="text" name="student_username" placeholder='username...'></p>
					<p><input type="password" name="student_password" placeholder='password...'><i id='show_password' class="fa-solid fa-eye-slash fa-sm"></i></p>

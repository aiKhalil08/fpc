...
$result = new Dec_Select_Result_Period($id, $sessions, $period, $info['student_class']); //declares form to select result period. declared in  page_view.php
...
<head>
	...
	<title><?=$_COOKIE['student_first_name'].' '.$_COOKIE['student_last_name']?> RESULTS</title>
</head>
<body>
    <header>
	...
	<main>
        ...
        <section class='spreadsheets'>
            <h3><?=$_COOKIE['student_first_name'].' '.$_COOKIE['student_last_name']?> RESULTS</h3>

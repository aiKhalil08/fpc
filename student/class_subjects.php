...
$all_subjects = new Get_Subjects($class, 1); // declared in contr.php
...
$view = new Show_Student_Subjects($all_subjects, $student_subjects); //declared in view.php
...
<head>
	...
	<title><?=$_COOKIE['student_class']?> SUBJECTS</title>
</head>
<body>
    <header>
	...
	<main>
        <?=check_js_enabled();?>
        <section class='student_subjects'>
            <h3><?=$_COOKIE['student_class']?> SUBJECTS</h3>
            <?php
            echo $view->show();
            ?>
        </section>
